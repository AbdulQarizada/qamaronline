                            ...
                            <div class="col-lg-12">
                                <div>
                                    ...
                                    <table class="table table-nowrap">
                                             <tr>
                                                <td>
                                                     <img src="{{URL::asset('/uploads/Profiles/'.$data -> Profile)}}" style="width: 130px; height: 135px;" class="rounded">
                                                </td>
                                       ...
                                       @endif
                                            ...
                                            <table class="table table-nowrap">
                                                <h5 style="font-weight: bold;" class="card-header  text-dark">DOCUMENTS</h5>
                                                    <tr>
                                                        <td style="width: 20%; border: 2px solid #000; padding: 5px;">Tazkira</td>
                                                        <td style="width: 40%; border: 2px solid #000; padding: 5px;"><a href="{{URL::asset('/uploads/Tazkiras/'.$data -> Tazkira)}}" class="badge badge-soft-info">{{ $data -> FirstName}} {{ $data -> LastName}} Tazkira</a></td>
