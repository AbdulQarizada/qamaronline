...
<div class="row">
                        ...
                        <tr>
                            <td>
                                <a target="_Blanck" href="{{URL::asset('/uploads/OrphansRelief/Orphans/Profiles/'.$data -> Profile)}}" class="badge badge-soft-info">
                                    <img src="{{URL::asset('/uploads/OrphansRelief/Orphans/Profiles/'.$data -> Profile)}}" style="width: 130px; height: 135px;" class="rounded">
                                </a>
                            </td>
                ...
                <div class="table-responsive">
                    ...
                    <table class="table table-nowrap">
                        ...
                        <tr>
                            ...
                            <td style="width: 40%; border: 2px solid #000; padding: 5px;"><a target="_Blanck" href="{{URL::asset('/uploads/OrphansRelief/Orphans/Tazkiras/'.$data -> Tazkira)}}" class="badge badge-soft-info">{{ $data -> FirstName}} {{ $data -> LastName}} Tazkira</a></td>
    ...
    <div class="row">
        <div class="col-12">
            ...
            <a href="{{route('ReInitiateOrphans', ['data' => $data -> id])}}" class="btn btn-info waves-effect waves-light reinitiate m-3">
                <i class="bx bx-time-five  font-size-16 align-middle"></i>Re-Initiate
            </a>
            @endif
            @if( $data -> Status == 'Pending')
            <a href="{{route('ApproveOrphans', ['data' => $data -> id])}}" class="btn btn-success waves-effect waves-light approve m-3">
                <i class="bx bx-check-circle font-size-16 align-middle"></i>Approve
            </a>
            <a href="{{route('RejectOrphans', ['data' => $data -> id])}}" class="btn btn-danger waves-effect waves-light reject m-3">
