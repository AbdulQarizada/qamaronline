...
<div class="row">
    ...
    <div class="col-md-2">
        <div class="d-flex flex-wrap gap-2">
            ...
            @if(Carbon\Carbon::now() >= $data -> EndDate)
            <a href="{{route('DeleteModuleScholarship', ['data' => $module -> id])}}" class="btn btn-sm btn-outline-danger  waves-effect waves-light delete-confirm" data-bs-toggle="tooltip" data-bs-placement="top" title="Delete Module"><i class="mdi mdi-delete-outline font-size-16 align-middle"></i></a>
           @endif
        </div>
    </div>
    @endforeach
