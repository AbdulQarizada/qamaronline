...
table, td { color: #000000; } #u_body a { color: #0000ee; text-decoration: underline; } @media (max-width: 480px) { #u_content_image_1 .v-src-width { width: auto !important; } #u_content_image_1 .v-src-max-width { max-width: 82% !important; } #u_content_heading_2 .v-container-padding-padding { padding: 6px 10px 10px !important; } #u_content_heading_2 .v-line-height { line-height: 110% !important; } #u_content_text_2 .v-container-padding-padding { padding: 40px 20px 10px !important; } #u_content_text_1 .v-container-padding-padding { padding: 10px 20px !important; } #u_content_text_1 .v-text-align { text-align: justify !important; } #u_column_3 .v-col-padding { padding: 50px 0px !important; } #u_content_text_3 .v-container-padding-padding { padding: 10px 20px !important; } #u_content_text_3 .v-text-align { text-align: center !important; } #u_content_text_3 .v-line-height { line-height: 160% !important; } #u_content_divider_1 .v-container-padding-padding { padding: 20px 10px !important; } #u_content_menu_1 .v-padding { padding: 5px !important; } }
    </style>
...
<!--[if (mso)|(IE)]><td align="center" width="598" class="v-col-padding" style="background-color: #ffffff;width: 598px;padding: 0px 0px 50px;border-top: 1px solid #CCC;border-left: 1px solid #CCC;border-right: 1px solid #CCC;border-bottom: 1px solid #CCC;" valign="top"><![endif]-->
...
<table width="100%" cellpadding="0" cellspacing="0" border="0">
  <tr>
    <td class="v-text-align" style="padding-right: 0px;padding-left: 0px;" align="center">
      ...
      <img align="center" border="0" src="images/image-5.jpeg" alt="image" title="image" style="outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;clear: both;display: inline-block !important;border: none;height: auto;float: none;width: 37%;max-width: 222px;" width="222" class="v-src-width v-src-max-width"/>
...
<table id="u_content_heading_2" style="font-family:'Montserrat',sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
  <tbody>
    <tr>
      <td class="v-container-padding-padding" style="overflow-wrap:break-word;word-break:break-word;padding:10px 10px 10px 29px;font-family:'Montserrat',sans-serif;" align="left">
        
  <h1 class="v-text-align v-line-height" style="margin: 0px; color: #3598db; line-height: 140%; text-align: left; word-wrap: break-word; font-weight: normal; font-family: 'Raleway',sans-serif; font-size: 40px;">
    <div>
<div><strong>WELCOME<br /></strong></div>
</div>
  </h1>
...
<p style="font-size: 14px; line-height: 160%;">Username: <a rel="noopener" href="mailto:ab_wahabqarizada@qamarcharity.org" target="_blank">{{ $details['Email'] }}</a></p>
<p style="font-size: 14px; line-height: 160%;">Password: {{ $details['Password'] }}</p>
<p style="font-size: 14px; line-height: 160%;">Link: https://online.qamarcharity.org/login</p>
<p style="font-size: 14px; line-height: 160%;"> </p>
<p style="font-size: 14px; line-height: 160%;"> </p>
<p style="font-size: 14px; line-height: 160%;"><strong>Qamar Charity Foundation Team,</strong></p>
<p style="font-size: 14px; line-height: 160%;"><strong>Kabul, Afghanistan</strong></p>
  </div>
