                    ...
                    <div class="row">
                        <div class="col-md-10">
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3 position-relative">
                                        <label for="FirstNameLocal" class="form-label ">Last Name <i class="mdi mdi-asterisk text-danger"></i></label>
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3 position-relative">
                                        <label for="LastNameLocal" class="form-label ">Job </label>
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3 position-relative">
                                        <label for="QCC" class="form-label ">Password</label>
                        ...
                        <div class="col-md-2">
                            <div class="mb-3 position-relative">
                                <div class="form-check mb-3">
                                    <input class="form-check-input @error('IsEmployee') is-invalid @enderror" type="checkbox" value="{{ old('IsEmployee') }}" id="IsEmployee" name="IsEmployee">
