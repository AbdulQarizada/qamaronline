                ...
                <div class="product-description">
                    <div class="product-label">
                        ...
                        <div class="product-name">
                            ...
                            <i class="bx bx-calendar me-1"></i> {{$data -> created_at -> todatestring()}}
                        </li>
                            <p></p>
                        </div>
                    </div>
                    <div class="product-option">
                        ...
                        <a href="{{route('AddToCartOrphans', ['data' => $data -> id])}}" class="btn  btn-warning  waves-effect waves-light mt-3 mb-3 me-1">
                      ...
                      <div class="row mb-3">
                                <div class="col-md-6">
                                    <div>
                                        ...
                                        <p class="text-muted"><i class="fas fa-baby-carriage  font-size-16 align-middle text-primary me-1"></i> {{\Carbon\Carbon::parse($data -> DOB)->diff(\Carbon\Carbon::now())->format('%y Years old');}}</p>
