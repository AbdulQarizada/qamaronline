...
<div class="row mt-4">
    ...
    <div class="col-md-4 col-sm-12">
        <a href="{{route('AllVolunteer')}}" class="btn btn-outline-info btn-lg waves-effect mb-3 btn-label waves-light"><i class="bx bx-left-arrow  font-size-16 label-icon"></i>Back</a>
