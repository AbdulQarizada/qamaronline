...
<div class="row">
    <div class="col-12">
        <a href="{{route('OrganizationServiceProviders')}}" class="btn btn-info btn-lg waves-effect btn-label waves-light m-3"><i class="bx bx-left-arrow  font-size-16 label-icon"></i>Back</a>
...
<div class="row">
    <div class="col-12">
        ...
        <a href="{{route('ReInitiateOrganizationServiceProviders', ['data' => $data -> id])}}" class="btn btn-info waves-effect waves-light reinitiate m-3">
            <i class="bx bx-time-five  font-size-16 align-middle"></i>Re-Initiate
        </a>
        @endif
        @if( $data -> Status == 'Pending')
        <a href="{{route('ApproveOrganizationServiceProviders', ['data' => $data -> id])}}" class="btn btn-success waves-effect waves-light approve m-3">
            <i class="bx bx-check-circle font-size-16 align-middle"></i>Approve
        </a>
        <a href="{{route('RejectOrganizationServiceProviders', ['data' => $data -> id])}}" class="btn btn-danger waves-effect waves-light reject m-3">
