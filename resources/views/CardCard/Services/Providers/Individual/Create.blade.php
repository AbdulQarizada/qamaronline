...
<form class="needs-validation" action="{{route('CreateIndividualServiceProviders')}}" method="POST" enctype="multipart/form-data" novalidate>
    @csrf
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="mb-3 position-relative">
                                ...
                                <input type="number" class="form-control form-control-lg @error('NumberOfFree') is-invalid @enderror" value="{{ old('NumberOfFree') }}" id="NumberOfFree" name="NumberOfFree" max="999999999" required>
                                @error('NumberOfFree')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                        ...
                        <div class="col-md-4">
                            <div class="mb-3 position-relative">
                                ...
                                <input type="number" class="form-control form-control-lg @error('Discount') is-invalid @enderror" value="{{ old('Discount') }}" id="Discount" name="Discount" max="100" required>
                                @error('Discount')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
...
<script>
    ...
    const Profile = FilePond.create(inputProfile, {
        ...
        server: {
            ...
            url: '{{ route('IndividualServiceProvider_Profile')}}',
            headers: {
    ...
    const Tazkira = FilePond.create(inputTazkira, {
        ...
        server: {
            ...
            url: '{{ route('IndividualServiceProvider_Tazkira')}}',
            headers: {
                'X-CSRF-TOKEN': '{{ csrf_token() }}'
            }
