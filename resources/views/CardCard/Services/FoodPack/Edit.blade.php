                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <textarea id="textarea" class="form-control @error('Description') is-invalid @enderror" maxlength="2002005" rows="10" value="{{$data -> Description}}" required name="Description" id="Description" required>{{$data -> Description}}</textarea>
                            @error('Description')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
