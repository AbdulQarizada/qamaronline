                ...
                <div class="card-body">
                    ...
                    <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="mb-3 position-relative">
                                        ...
                                        <input type="number" class="form-control form-control-lg @error('TargetBeneficiaries') is-invalid @enderror" value="{{ old('TargetBeneficiaries') }}" id="TargetBeneficiaries" name="TargetBeneficiaries" max="999999999" required>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <textarea id="textarea" class="form-control @error('Description') is-invalid @enderror" maxlength="2205" rows="10" value="{{ old('Description') }}" required name="Description" id="Description" required></textarea>
