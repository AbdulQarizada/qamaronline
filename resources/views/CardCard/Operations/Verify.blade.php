...
<div class="row">
    <div class="col-12">
        <a href="{{route('IndexCareCard')}}" class="btn btn-info btn-lg waves-effect btn-label waves-light m-3"><i class="bx bx-left-arrow  font-size-16 label-icon"></i>Back</a>
    </div>
</div>
@endif
<div class="row justify-content-center">
    <div class="col-lg-8 ">
        ...
        <form action="{{route('SearchCareCard')}}" method="POST">
            @csrf
