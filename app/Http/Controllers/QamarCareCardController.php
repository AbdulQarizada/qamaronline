...
class QamarCareCardController extends Controller
{
  ...
  // index
    ...
    public function Store(Request $request)
    {
      ...
      'PrimaryNumber' => 'required|digits_between:1,12',
      'SecondaryNumber' => 'required|digits_between:1,12',
      'EmergencyNumber' => 'required|digits_between:1,12',
      ...
      'EldestSonAge' => 'required|digits_between:1,3',
      'MonthlyFamilyIncome' => 'required|digits_between:1,5',
      'MonthlyFamilyExpenses' => 'required|digits_between:1,5',
