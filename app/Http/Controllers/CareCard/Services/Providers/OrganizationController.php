...
namespace App\Http\Controllers\CareCard\Services\Providers;
...
class OrganizationController extends Controller
{
  ...
  {
    return view('QamarCardCard.ProviderIndex');
  }

  public function All()
  {

    $datas =   ServiceProviders::join('locations as a', 'service_providers.Province_ID', '=', 'a.id')
      ...
      ->get();
    return view('CardCard.Services.Providers.Organization.All', ['datas' => $datas]);
  }
  ...
  public function Create()
  {
    ...
    return view('CardCard.Services.Providers.Organization.Create', ['provinces' => $provinces, 'servicetypes' => $servicetypes, 'genders' => $genders, 'languages' => $languages, 'currentjobs' => $currentjobs, 'professions' => $professons, 'educationlevels' => $educationlevels]);
  }
  ...
  public function Store(Request $request)
  {
    ...
    return redirect()->route('OrganizationServiceProviders')->with('toast_success', 'Record Created Successfully!');
  }
  ...
  // Delete
  public function Delete(ServiceProviders $data)
  {
  ...
  public function Status(ServiceProviders $data)
  {

    $datas =   ServiceProviders::where("service_providers.id", "=", $data->id)
    ...
    return view('CardCard.Services.Providers.Organization.Status',  ['datas' => $datas]);
  }


  public function Approve(ServiceProviders $data)
  {
    ...
    return redirect()->route('OrganizationServiceProviders')->with('toast_success', 'The card has been Printed!');
  }


  public function ReInitiate(ServiceProviders $data)
  {
    ...
    return redirect()->route('OrganizationServiceProviders')->with('toast_success', 'The card has been Re Initiated!');
  }


  public function Reject(ServiceProviders $data)
  {
    ...
    return redirect()->route('OrganizationServiceProviders')->with('toast_success', 'The card has been rejected!');
  }
