...
class IndividualController extends Controller
{
  ...
  public function All()
  {
    ...
    $datas =   ServiceProviders::join('locations as a', 'service_providers.Province_ID', '=', 'a.id')
      ...
      ->get();
    return view('CardCard.Services.Providers.Individual.All', ['datas' => $datas]);
  }
  ...
  public function Create()
  {
    ...
    return view('CardCard.Services.Providers.Individual.Create', ['provinces' => $provinces, 'servicetypes' => $servicetypes, 'genders' => $genders, 'languages' => $languages, 'currentjobs' => $currentjobs, 'professions' => $professons, 'educationlevels' => $educationlevels]);
  }
  ...
  public function Store(Request $request)
  {
    ...
    return redirect()->route('IndividualServiceProviders')->with('toast_success', 'Record Created Successfully!');
  }
  ...
  public function Status(ServiceProviders $data)
  {
    ...
    return view('CardCard.Services.Providers.Individual.Status',  ['datas' => $datas]);
  }
  ...
  public function Approve(ServiceProviders $data)
  {
    ...
    return redirect()->route('IndividualServiceProviders')->with('toast_success', 'The card has been Printed!');
  }
  ...
  public function ReInitiate(ServiceProviders $data)
  {
    ...
    return redirect()->route('IndividualServiceProviders')->with('toast_success', 'The card has been Re Initiated!');
  }
  ...
  public function Reject(ServiceProviders $data)
  {
    ...
    return redirect()->route('IndividualServiceProviders')->with('toast_success', 'The card has been rejected!');
  }
