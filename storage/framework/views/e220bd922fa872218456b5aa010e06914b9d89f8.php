...
<?php $__env->startSection('css'); ?>
    <!-- dragula css -->
    <link href="<?php echo e(URL::asset('/assets/libs/dragula/dragula.min.css')); ?>" rel="stylesheet" type="text/css" />
                                    ...
                                    <div class="avatar-group float-start task-assigne">
                                        ...
                                        <div class="avatar-group-item">
                                            <a href="javascript: void(0);" class="d-inline-block" value="member-5">
                                                <img src="<?php echo e(URL::asset('/assets/images/users/avatar-5.jpg')); ?>" alt="" class="rounded-circle avatar-xs">
                                            </a>
                                        </div>
                                        <div class="avatar-group-item">
                                            <a href="javascript: void(0);" class="d-inline-block" value="member-6">
                                                <img src="<?php echo e(URL::asset('/assets/images/users/avatar-2.jpg')); ?>" alt="" class="rounded-circle avatar-xs">
                                            </a>
                                        </div>
                                        <div class="avatar-group-item">
                                    ...
                                    <div class="avatar-group float-start task-assigne">
                                        <div class="avatar-group-item">
                                            <a href="javascript: void(0);" class="d-inline-block" value="member-1">
                                                <img src="<?php echo e(URL::asset('/assets/images/users/avatar-1.jpg')); ?>" alt="" class="rounded-circle avatar-xs">
                                            </a>
                                        </div>
                                        <div class="avatar-group-item">
                                    ...
                                    <ul class="list-inine ps-0 mb-4">
                                            ...
                                            <a href="#">
                                                <div class="border rounded avatar-sm">
                                                    <span class="avatar-title bg-transparent">
                                                        <img src="<?php echo e(URL::asset('/assets/images/companies/img-1.png')); ?>" alt="" class="avatar-xs">
                                                    </span>
                                                </div>
                                            </a>
                                        </li>
                                        <li class="list-inline-item">
                                            <a href="#">
                                                <div class="border rounded avatar-sm">
                                                    <span class="avatar-title bg-transparent">
                                                        <img src="<?php echo e(URL::asset('/assets/images/companies/img-2.png')); ?>" alt="" class="avatar-xs">
                                                    </span>
                                                </div>
                                            </a>
                                        </li>
                                        <li class="list-inline-item">
                                            <a href="#">
                                                <div class="border rounded avatar-sm">
                                                    <span class="avatar-title bg-transparent">
                                                        <img src="<?php echo e(URL::asset('/assets/images/companies/img-3.png')); ?>" alt="" class="avatar-xs">
                                                    </span>
                                                </div>
                                            </a>
                                        </li>
                                    ...
                                    <div class="avatar-group float-start task-assigne">
                                        <div class="avatar-group-item">
                                            <a href="javascript: void(0);" class="d-inline-block" value="member-7">
                                                <img src="<?php echo e(URL::asset('/assets/images/users/avatar-7.jpg')); ?>" alt="" class="rounded-circle avatar-xs">
                                            </a>
                                        </div>
                                        <div class="avatar-group-item">
                                            <a href="javascript: void(0);" class="d-inline-block" value="member-8">
                                                <img src="<?php echo e(URL::asset('/assets/images/users/avatar-8.jpg')); ?>" alt="" class="rounded-circle avatar-xs">
                                            </a>
                                        </div>
                                    </div>
                            ...
                            <div class="card task-box" id="intask-2">
                                <div class="card-body">
                                    ...
                                    <div class="avatar-group float-start task-assigne">
                                        <div class="avatar-group-item">
                                            <a href="javascript: void(0);" class="d-inline-block" value="member-6">
                                                <img src="<?php echo e(URL::asset('/assets/images/users/avatar-6.jpg')); ?>" alt="" class="rounded-circle avatar-xs">
                                            </a>
                                        </div>
                                        <div class="avatar-group-item">
                                            <a href="javascript: void(0);" class="d-inline-block" value="member-4">
                                ...
                                <div class="card-body">
                                    ...
                                    <ul class="list-inline mb-4">
                                        <li class="list-inline-item">
                                            <a href="#">
                                                <div>
                                                    <img src="<?php echo e(URL::asset('/assets/images/small/img-4.jpg')); ?>" class="rounded" alt="" height="48">
                                                </div>
                                            </a>
                                        </li>
                                        <li class="list-inline-item">
                                            <a href="#">
                                                <div>
                                                    <img src="<?php echo e(URL::asset('/assets/images/small/img-5.jpg')); ?>" class="rounded" alt="" height="48">
                                                </div>
                                            </a>
                                        </li>
                                        <li class="list-inline-item">
                                            <a href="#">
                                                <div>
                                                    <img src="<?php echo e(URL::asset('/assets/images/small/img-6.jpg')); ?>" class="rounded" alt="" height="48">
                                                </div>
                                            </a>
                                        </li>
                                    </ul>
                            ...
                            <ul class="list-unstyled user-list validate" id="taskassignee">
                                <li>
                                    <div class="form-check form-check-primary mb-2 d-flex align-items-center">
                                        ...
                                        <img src="<?php echo e(URL::asset('/assets/images/users/avatar-1.jpg')); ?>" class="rounded-circle avatar-xs m-1" alt="">
                                    </div>
                                </li>
                                <li>
                                    <div class="form-check form-check-primary mb-2 d-flex align-items-center">
                                        ...
                                        <img src="<?php echo e(URL::asset('/assets/images/users/avatar-2.jpg')); ?>" class="rounded-circle avatar-xs m-1" alt="">
                                    </div>
                                </li>
                                <li>
                                    <div class="form-check form-check-primary mb-2 d-flex align-items-center">
                                        ...
                                        <img src="<?php echo e(URL::asset('/assets/images/users/avatar-3.jpg')); ?>" class="rounded-circle avatar-xs m-1" alt="">
                                    </div>
                                </li>
                                <li>
                                    <div class="form-check form-check-primary mb-2 d-flex align-items-center">
                                        ...
                                        <img src="<?php echo e(URL::asset('/assets/images/users/avatar-4.jpg')); ?>" class="rounded-circle avatar-xs m-1" alt="">
                                    </div>
                                </li>
                                <li>
                                    <div class="form-check form-check-primary mb-2 d-flex align-items-center">
                                        ...
                                        <img src="<?php echo e(URL::asset('/assets/images/users/avatar-5.jpg')); ?>" class="rounded-circle avatar-xs m-1" alt="">
                                    </div>
                                </li>
                                <li>
                                    <div class="form-check form-check-primary mb-2 d-flex align-items-center">
                                        ...
                                        <img src="<?php echo e(URL::asset('/assets/images/users/avatar-6.jpg')); ?>" class="rounded-circle avatar-xs m-1" alt="">
                                    </div>
                                </li>
                                <li>
                                    <div class="form-check form-check-primary mb-2 d-flex align-items-center">
                                        ...
                                        <img src="<?php echo e(URL::asset('/assets/images/users/avatar-7.jpg')); ?>" class="rounded-circle avatar-xs m-1" alt="">
                                    </div>
                                </li>
                                <li>
                                    <div class="form-check form-check-primary mb-2 d-flex align-items-center">
                                        ...
                                        <img src="<?php echo e(URL::asset('/assets/images/users/avatar-8.jpg')); ?>" class="rounded-circle avatar-xs m-1" alt="">
                                    </div>
                                </li>
                            </ul>
                        </div>
...
<?php $__env->startSection('script'); ?>
    ...
    <!-- jquery-validation -->
    <script src="<?php echo e(URL::asset('/assets/libs/jquery-validation/jquery-validation.min.js')); ?>"></script>

    <script src="<?php echo e(URL::asset('/assets/js/pages/task-kanban.init.js')); ?>"></script>

    <script src="<?php echo e(URL::asset('/assets/js/pages/task-form.init.js')); ?>"></script>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Home\Desktop\Qamar\Qamar Charity\QamarOnline\Online\resources\views/tasks-kanban.blade.php ENDPATH**/ ?>