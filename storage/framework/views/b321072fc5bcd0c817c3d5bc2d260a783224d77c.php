    ...
    <div class="row">
        ...
        <div class="col-xl-3 col-sm-6">
            <div class="card text-center">
                <div class="card-body">
                    <div class="mb-4">
                        <img class="rounded-circle avatar-sm" src="<?php echo e(URL::asset('/assets/images/users/avatar-2.jpg')); ?>" alt="">
                    </div>
        ...
        <div class="col-xl-3 col-sm-6">
            <div class="card text-center">
                <div class="card-body">
                    <div class="mb-4">
                        <img class="rounded-circle avatar-sm" src="<?php echo e(URL::asset('/assets/images/users/avatar-3.jpg')); ?>" alt="">
                    </div>
    ...
    <div class="row">
        <div class="col-xl-3 col-sm-6">
            <div class="card text-center">
                <div class="card-body">
                    <div class="mb-4">
                        <img class="rounded-circle avatar-sm" src="<?php echo e(URL::asset('/assets/images/users/avatar-4.jpg')); ?>" alt="">
                    </div>
        ...
        <div class="col-xl-3 col-sm-6">
            <div class="card text-center">
                <div class="card-body">
                    <div class="mb-4">
                        <img class="rounded-circle avatar-sm" src="<?php echo e(URL::asset('/assets/images/users/avatar-5.jpg')); ?>" alt="">
                    </div>
        ...
        <div class="col-xl-3 col-sm-6">
            <div class="card text-center">
                <div class="card-body">
                    <div class="mb-4">
                        <img class="rounded-circle avatar-sm" src="<?php echo e(URL::asset('/assets/images/users/avatar-7.jpg')); ?>" alt="">
                    </div>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Home\Desktop\Qamar\Qamar Charity\QamarOnline\Online\resources\views/contacts-grid.blade.php ENDPATH**/ ?>