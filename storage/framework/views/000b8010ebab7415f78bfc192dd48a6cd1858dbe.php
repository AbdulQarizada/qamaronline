...
<?php if(Auth::check()): ?> 
    ...
    <div class="row">
     ...
     <form action="<?php echo e(route('SearchQamarCareCard')); ?>" method="POST">
     <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.master-layouts', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Home\Desktop\Qamar\qamaronline\qamaronline\resources\views/QamarCardCard/Verify.blade.php ENDPATH**/ ?>