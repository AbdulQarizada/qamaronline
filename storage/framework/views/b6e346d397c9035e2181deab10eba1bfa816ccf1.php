                        ...
                        <tbody>
                            <?php $__currentLoopData = $scholarships; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $scholarship): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                               ...
                               <!-- <td>
                                ...
                                <td>
                                <div>
                                    <h5 class="font-size-14 mb-1"><a href="#" class="text-dark"><?php echo e($scholarship -> UFirstName); ?> <?php echo e($scholarship -> ULastName); ?></a></h5>
                                    <p class="text-muted mb-0"><?php echo e($scholarship -> UJob); ?></p> 
...
<?php echo $__env->make('layouts.master-layouts', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\TheDeveloper\Desktop\Qamar\QamarOnline\qamaronline\resources\views/Education/Scholarship/All.blade.php ENDPATH**/ ?>