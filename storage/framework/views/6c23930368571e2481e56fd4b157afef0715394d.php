...
<div class="row">
    <div class="col-12">
        <a href="<?php echo e(route('OrganizationServiceProviders')); ?>" class="btn btn-info btn-lg waves-effect btn-label waves-light m-3"><i class="bx bx-left-arrow  font-size-16 label-icon"></i>Back</a>
...
<div class="row">
    <div class="col-12">
        ...
        <a href="<?php echo e(route('ReInitiateOrganizationServiceProviders', ['data' => $data -> id])); ?>" class="btn btn-info waves-effect waves-light reinitiate m-3">
            <i class="bx bx-time-five  font-size-16 align-middle"></i>Re-Initiate
        </a>
        <?php endif; ?>
        <?php if( $data -> Status == 'Pending'): ?>
        <a href="<?php echo e(route('ApproveOrganizationServiceProviders', ['data' => $data -> id])); ?>" class="btn btn-success waves-effect waves-light approve m-3">
            <i class="bx bx-check-circle font-size-16 align-middle"></i>Approve
        </a>
        <a href="<?php echo e(route('RejectOrganizationServiceProviders', ['data' => $data -> id])); ?>" class="btn btn-danger waves-effect waves-light reject m-3">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master-layouts', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\TheDeveloper\Desktop\Projects\Qamar\qamaronline\resources\views/CardCard/Services/Providers/Organization/Status.blade.php ENDPATH**/ ?>