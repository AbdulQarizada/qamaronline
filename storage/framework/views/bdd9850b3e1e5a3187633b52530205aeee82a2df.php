...
<div class="row mt-4">
    <div class="col-6">
        <a href="<?php echo e(route('IndividualServiceProviders')); ?>" class="btn btn-info btn-lg waves-effect mb-3 btn-label waves-light"><i class="bx bx-left-arrow  font-size-16 label-icon"></i>Back</a>

        <span class="my-0   card-title fw-medium font-size-24 text-wrap"><i class="bx bx-caret-right text-secondary font-size-20"></i>ADD SERVICE PROVIDER</span>

    </div>
</div>

<form class="needs-validation" action="<?php echo e(route('CreateIndividualServiceProviders')); ?>" method="POST" enctype="multipart/form-data" novalidate>
    <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card ">
                <h4 class="card-header bg-dark text-white ">SERIVCE AND CONTACT</h4>
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('NumberOfFree')); ?>" id="NumberOfFree" name="NumberOfFree" max="999999999" required>
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('Discount')); ?>" id="Discount" name="Discount" max="100" required>
...
<script>
    ...
    const Profile = FilePond.create(inputProfile, {
        ...
        server: {
            ...
            url: '<?php echo e(route('IndividualServiceProvider_Profile')); ?>',
            headers: {
    ...
    const Tazkira = FilePond.create(inputTazkira, {
        ...
        server: {
            ...
            url: '<?php echo e(route('IndividualServiceProvider_Tazkira')); ?>',
            headers: {
                'X-CSRF-TOKEN': '<?php echo e(csrf_token()); ?>'
            }
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master-layouts', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\TheDeveloper\Desktop\Projects\Qamar\qamaronline\resources\views/CardCard/Services/ServiceProviders/Individual/Create.blade.php ENDPATH**/ ?>