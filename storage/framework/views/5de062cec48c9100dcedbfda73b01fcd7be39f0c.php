...
<?php $__env->startSection('title'); ?> Edit Food Packs <?php $__env->stopSection(); ?>
...
<form class="needs-validation" action="<?php echo e(route('UpdateFoodPack', [$data -> id])); ?>" method="POST" enctype="multipart/form-data" novalidate>
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e($data -> Name); ?>" id="Name" name="Name" required>
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e($data -> TotalBudget); ?>" id="TotalBudget" name="TotalBudget" max="999999999" required>
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e($data -> TargetBeneficiaries); ?>" id="TargetBeneficiaries" name="TargetBeneficiaries" max="999999999" required>
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e($data -> ExpectedDate); ?>" type="date" id="example-date-input" name="ExpectedDate" id="ExpectedDate" required>
...
unset($__errorArgs, $__bag); ?>" maxlength="2205" rows="10" value="<?php echo e($data -> Description); ?>" required name="Description" id="Description" required></textarea>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master-layouts', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\TheDeveloper\Desktop\Projects\Qamar\qamaronline\resources\views/CardCard/Services/FoodPack/Edit.blade.php ENDPATH**/ ?>