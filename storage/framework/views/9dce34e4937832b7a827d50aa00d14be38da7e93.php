...
<div class="row">
    ...
    <div class="col-8 ">
        ...
        <a href="<?php echo e(route('CreateOrganizationServiceProviders')); ?>" class="btn btn-success btn-lg waves-effect  waves-light mb-3 float-end btn-rounded"><i class="mdi mdi-plus me-1"></i>ADD SERVICE PROVIDER</a>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="d-flex flex-wrap gap-2">
                                    <a href="<?php echo e(route('StatusOrganizationServiceProviders', ['data' => $data -> id])); ?>" class="btn btn-warning waves-effect waves-light">
                                        <i class="bx bx-show-alt font-size-16 align-middle"></i>
                                    </a>

                                    <?php if( $data -> Status !="Approved"): ?>
                                    <a href="<?php echo e(route('DeleteOrganizationServiceProviders', ['data' => $data -> id])); ?>" class="btn btn-danger waves-effect waves-light Delete">
