...
<div class="row mt-4">
    ...
    <div class="col-md-4 col-sm-12">
        <a href="<?php echo e(route('AllRepresentative')); ?>" class="btn btn-outline-info btn-lg waves-effect mb-3 btn-label waves-light"><i class="bx bx-left-arrow  font-size-16 label-icon"></i>Back</a>
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('PrimaryNumber')); ?>" id="PrimaryNumber" name="PrimaryNumber" required>
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('Address')); ?>" id="Address" name="Address">
...
<?php echo $__env->make(Cookie::get('Layout') == 'LayoutSidebar' ? 'Layouts.master' : 'Layouts.master-layouts', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\TheDeveloper\Desktop\Projects\Qamar\qamaronline\resources\views/Representative/Create.blade.php ENDPATH**/ ?>