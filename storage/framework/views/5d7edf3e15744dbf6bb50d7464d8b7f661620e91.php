...
unset($__errorArgs, $__bag); ?>" onchange="window.location.href=this.value;">
            ...
            <option value="<?php echo e(route('AllSponsor')); ?>">All</option>
            <option value="<?php echo e(route('ActiveSponsor')); ?>">Active</option>
            <option value="<?php echo e(route('InActiveSponsor')); ?>">InActive</option>
        </select>
    </div>
    <div class="col-9">
        <a href="<?php echo e(route('CreateSponsor')); ?>" class="btn btn-success btn-lg waves-effect  waves-light mb-3 float-end btn-rounded"><i class="mdi mdi-plus me-1"></i>ADD SPONSOR</a>
    </div>
</div>
<div class="row">
    <div class="col-12">
