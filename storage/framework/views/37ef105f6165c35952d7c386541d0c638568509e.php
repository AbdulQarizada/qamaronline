...
<div class="row mt-4">
    <div class="col-md-4 col-sm-12">
        ...
        <span class="my-0   card-title fw-medium font-size-24 text-wrap text-uppercase"><i class="bx bx-caret-right text-secondary font-size-20 "></i>Add Application</span>
    </div>
</div>
<form class="needs-validation" action="<?php echo e(route('CreateApplication')); ?>" method="POST" enctype="multipart/form-data" novalidate>
    <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="row mt-4">
                            ...
                            <div class="col-sm-6">
                                <div class="text-end">
                                    <a onclick="work();" class="btn btn-outline-success btn-lg waves-effect  waves-light float-end btn-rounded w-lg">
                                        Next </a>
                                </div>
                            </div>
                        </div>
...
<script>
    ...
    const Profile = FilePond.create(inputProfile, {
        ...
        , server: {
            url: '<?php echo e(route('Applicant_Profile')); ?>'
            , headers: {
    ...
    const Tazkira = FilePond.create(inputTazkira, {
        ...
        , server: {
            ...
            url: '<?php echo e(route('Applicant_Tazkira')); ?>'
            , headers: {
                'X-CSRF-TOKEN': '<?php echo e(csrf_token()); ?>'
            }
    ...
    const SchoolDiploma = FilePond.create(inputSchoolDiploma, {
        ...
        , server: {
            ...
            url: '<?php echo e(route('Applicant_SchoolDiploma')); ?>'
            , headers: {
                'X-CSRF-TOKEN': '<?php echo e(csrf_token()); ?>'
            }
    ...
    const SchoolTranscript = FilePond.create(inputSchoolTranscript, {
        ...
        , server: {
            ...
            url: '<?php echo e(route('Applicant_SchoolTranscript')); ?>'
            , headers: {
                'X-CSRF-TOKEN': '<?php echo e(csrf_token()); ?>'
            }
    ...
    const EnglishDiploma = FilePond.create(inputEnglishDiploma, {
        ...
        , server: {
            ...
            url: '<?php echo e(route('Applicant_EnglishDiploma')); ?>'
            , headers: {
                'X-CSRF-TOKEN': '<?php echo e(csrf_token()); ?>'
            }
        }
    ...
    const WorkExperienceLetter = FilePond.create(inputWorkExperienceLetter, {
        ...
        , server: {
            ...
            url: '<?php echo e(route('Applicant_WorkExperienceLetter')); ?>'
            , headers: {
                'X-CSRF-TOKEN': '<?php echo e(csrf_token()); ?>'
            }
        }
    ...
    const Resume = FilePond.create(inputResume, {
        ...
        , server: {
            ...
            url: '<?php echo e(route('Applicant_Resume')); ?>'
            , headers: {
                'X-CSRF-TOKEN': '<?php echo e(csrf_token()); ?>'
            }
        }
    ...
    $(document).ready(function() {
        $('.ScholarshipType').on('change', function() {
            ...
            if (dID) {
                $.ajax({
                    url: '<?php echo e(route('GetScholarshipAjax')); ?>'
                    , type: "GET"
                    , data: {
                        "_token": "<?php echo e(csrf_token()); ?>"
                        , "data": dID
    ...
    $(document).ready(function() {
        $('.Scholarship').on('change', function() {
            ...
            if (dID) {
                $.ajax({
                    url: '<?php echo e(route('GetScholarshipModuleAjax')); ?>'
                    , type: "GET"
                    , data: {
                        "_token": "<?php echo e(csrf_token()); ?>"
                        , "data": dID
...
<?php echo $__env->make(Cookie::get('Layout') == 'LayoutSidebar' ? 'Layouts.master' : 'Layouts.master-layouts', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\TheDeveloper\Desktop\Projects\Qamar\qamaronline\resources\views/Education/Application/Create.blade.php ENDPATH**/ ?>