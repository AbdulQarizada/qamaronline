...
<form class="needs-validation" action="<?php echo e(route('SearchEligibleBeneficieriesFoodPack')); ?>" method="POST" enctype="multipart/form-data" novalidate>
    <?php echo csrf_field(); ?>
    <div class="row">
...
<form class="needs-validation" action="<?php echo e(route('AssignToFoodPack')); ?>" method="POST" enctype="multipart/form-data" novalidate>
    <?php echo csrf_field(); ?>
    <div class="row">
        <div class="col-12">
                                ...
                                <div class="col-md-10">
                                    <div class="mb-3 position-relative">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <select class="form-select  form-select-lg <?php $__errorArgs = ['FoodPack_ID'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="col-md-2">
                                    <div class="mb-3 position-relative">
                                        ...
                                        <a href="<?php echo e(route('CreateFoodPack')); ?>" class="btn btn-info btn-lg"><i class="bx bx-plus-circle "></i></a>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master-layouts', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\TheDeveloper\Desktop\Projects\Qamar\qamaronline\resources\views/CardCard/Services/FoodPack/EligibalBeneficieries.blade.php ENDPATH**/ ?>