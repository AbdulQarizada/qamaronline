                        ...
                        <table class="table align-middle table-nowrap table-hover">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>
                                        <div>
                                            <img class="rounded-circle avatar-xs" src="<?php echo e(URL::asset('/assets/images/users/avatar-2.jpg')); ?>"
                                                alt="">
                                        </div>
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    <td>
                                        <div>
                                            <img class="rounded-circle avatar-xs" src="<?php echo e(URL::asset('/assets/images/users/avatar-3.jpg')); ?>"
                                                alt="">
                                        </div>
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    <td>
                                        <div>
                                            <img class="rounded-circle avatar-xs" src="<?php echo e(URL::asset('/assets/images/users/avatar-4.jpg')); ?>"
                                                alt="">
                                        </div>
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    <td>
                                        <div>
                                            <img class="rounded-circle avatar-xs" src="<?php echo e(URL::asset('/assets/images/users/avatar-5.jpg')); ?>"
                                                alt="">
                                        </div>
                                    </td>
                                    <td>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Home\Desktop\Qamar\Qamar Charity\QamarOnline\Online\resources\views/contacts-list.blade.php ENDPATH**/ ?>