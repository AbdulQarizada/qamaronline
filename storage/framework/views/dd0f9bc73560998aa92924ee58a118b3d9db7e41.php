    ...
    <div class="col-md-12">
        <div class="collapse hide" id="addUser">
            <div class="card shadow-none card-body text-muted mb-0 mb-4" style="border: 2px dashed #50a5f1;">
                <form class="needs-validation" action="<?php echo e(route('UpdateProfileUser', [$data -> id])); ?>" method="POST" enctype="multipart/form-data" novalidate>
...
<div class="row ">
    <div class="col-md-12">
        <div class="collapse hide" id="resetPassord">
            <div class="card shadow-none card-body text-muted mb-0 mb-4" style="border: 2px dashed #50a5f1;">
                <form class="needs-validation" action="<?php echo e(route('UpdatePasswordUser', [$data -> id])); ?>" method="POST" enctype="multipart/form-data" novalidate>
                    <?php echo method_field('PUT'); ?>
                    <?php echo csrf_field(); ?>
                    <div class="checkout-tabs">
                        <div class="row">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-4">
                                                                <div class="mb-3 position-relative">
                                                                    ...
                                                                    <input class="form-control form-control-lg me-auto <?php $__errorArgs = ['current_password'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('current_password')); ?>" type="text" name="current_password" id="current_password" required>
...
unset($__errorArgs, $__bag); ?>
                                                            ...
                                                            <div class="col-md-4">
                                                                <div class="mb-3 position-relative">
                                                                    ...
                                                                    <input class="form-control form-control-lg me-auto <?php $__errorArgs = ['password_confirmation'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('password_confirmation')); ?>" type="text" name="password_confirmation" id="password_confirmation" required>
...
<script>
    ...
    const Profile = FilePond.create(inputProfile, {
        ...
        , files: [{
            source: '<?php echo e(Auth::user() -> Profile); ?>'
            , options: {
                type: 'local'
                , file: {
                    type: 'image/png'
                ...
                , metadata: {
                    poster: '<?php echo e(URL::asset('/uploads/User/Profiles/'.Auth::user() -> Profile)); ?>'
                }
            }
        }]
    , });
...
<?php echo $__env->make(Cookie::get('Layout') == 'LayoutSidebar' ? 'Layouts.master' : 'Layouts.master-layouts', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\TheDeveloper\Desktop\Projects\Qamar\qamaronline\resources\views/SystemManagement/User/Profile.blade.php ENDPATH**/ ?>