...
<div class="row mt-4">
    <div class="col-4">
        ...
        <span class="my-0   card-title fw-medium font-size-24 text-wrap text-uppercase">
            <i class="bx bx-caret-right text-secondary font-size-20 "></i>Edit Subscription
        </span>
    </div>
</div>
...
unset($__errorArgs, $__bag); ?>
                                            ...
                                            <div class="col-md-4">
                                                <div class="mb-3 position-relative">
                                                    ...
                                                    <div class="input-group " id="example-date-input">
                                                        <select class="form-control  form-control-lg" id="Orphan_ID" name="Orphan_ID" value="<?php echo e($data -> Orphan_ID); ?>" style="height: calc(1.5em + .75rem + 2px) !important;" required>
                                                            ...
                                                            <option value="<?php echo e($orphan -> id); ?>" <?php echo e($orphan -> id == $data -> Orphan_ID ? 'selected' : ''); ?>><?php echo e($orphan -> Firstname); ?> <?php echo e($orphan -> LastName); ?></option>
                                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                        </select>
...
<?php echo $__env->make(Cookie::get('Layout') == 'LayoutSidebar' ? 'Layouts.master' : 'Layouts.master-layouts', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\TheDeveloper\Desktop\Projects\Qamar\qamaronline\resources\views/OrphansRelief/Subscription/Edit.blade.php ENDPATH**/ ?>