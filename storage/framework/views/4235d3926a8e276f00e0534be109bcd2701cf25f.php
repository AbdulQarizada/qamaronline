...
unset($__errorArgs, $__bag); ?>" onchange="window.location.href=this.value;">
                <option value="<?php echo e(route('AllCard')); ?>">Please Filter Your Choices</option>
                <option value="<?php echo e(route('AllCard')); ?>" <?php echo e($PageInfo == 'All' ? 'selected' : ''); ?>>All</option>
                <option value="<?php echo e(route('ActiveCard')); ?>" <?php echo e($PageInfo == 'Active' ? 'selected' : ''); ?>>Active</option>
                <option value="<?php echo e(route('InActiveCard')); ?>" <?php echo e($PageInfo == 'InActive' ? 'selected' : ''); ?>>InActive</option>
            </select>
        </div>
    </div>
            ...
            <table class="table table-hover table-striped dt-responsive nowrap w-100">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <div>
                                <h5 class="font-size-14 mb-1"><a href="#" class="text-dark badge badge-soft-primary"><?php echo e($data -> user -> PrimaryNumber); ?></a></h5>
                                <p class="text-muted mb-0 badge badge-soft-warning"><?php echo e($data -> user -> SecondaryNumber); ?></p>
                            </div>
                        </td>
                        <td>
                            <div>
                                ...
                                <i class="mdi mdi-asterisk text-danger"></i>
                                <i class="mdi mdi-asterisk text-danger"></i>
                                <i ><?php echo e($data -> CardLastFourDigit); ?></i>
                            </div>
                        </td>
                        <td>                          
                        ...
                        <td>
                            <div class="d-flex flex-wrap gap-2">
                                <?php if( $data -> IsActive == 1): ?>
                                <a href="<?php echo e(route('DeActivateCard', ['data' => $data -> id])); ?>" class="btn btn-sm btn-outline-danger waves-effect DeActivateCard waves-light" data-bs-toggle="tooltip" data-bs-placement="top" title="De-Activate Card">
                                    <i class="mdi mdi-credit-card-remove-outline font-size-16 align-middle"></i>
                                </a>
                                <?php endif; ?>
                                <?php if($data -> IsActive != 1): ?>
                                <a href="<?php echo e(route('ActivateCard', ['data' => $data -> id])); ?>"  class="btn btn-sm btn-outline-success waves-effect ActivateCard waves-light" data-bs-toggle="tooltip" data-bs-placement="top" title="Activate Card">
                                    <i class="mdi mdi-credit-card-check-outline font-size-16 align-middle"></i>
                                </a>
                                <a href="<?php echo e(route('EditCard', ['data' => $data -> id])); ?>" class="btn btn-sm btn-outline-info waves-effect waves-light" data-bs-toggle="tooltip" data-bs-placement="top" title="Edit Details">
                                    <i class="mdi mdi-square-edit-outline font-size-16 align-middle"></i>
                                </a>
                                <a href="<?php echo e(route('DeleteCard', ['data' => $data -> id])); ?>" class="btn btn-sm btn-outline-danger waves-effect waves-light delete-confirm" data-bs-toggle="tooltip" data-bs-placement="top" title="Delete Record">
...
<?php echo $__env->make(Cookie::get('Layout') == 'LayoutSidebar' ? 'Layouts.master' : 'Layouts.master-layouts', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\TheDeveloper\Desktop\Projects\Qamar\qamaronline\resources\views/OrphansRelief/Card/All.blade.php ENDPATH**/ ?>