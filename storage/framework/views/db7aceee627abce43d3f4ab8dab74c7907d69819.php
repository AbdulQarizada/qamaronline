...
<?php $__env->startSection('content'); ?>
    ...
    <div class="col-xl-12">
        ...
        <!-- <div class="col-md-4 mb-2">
            ...
            <div class="col-md-4 mb-2">
        <a href="<?php echo e(route('IndexAssignServiceQamarCareCard')); ?>">
            <div class="card-one mini-stats-wid border border-secondary">
                <div class="card-body">
                  <blockquote class="blockquote font-size-14 mb-0">
                    <div class="d-flex">
...
<?php echo $__env->make('layouts.master-layouts', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\TheDeveloper\Desktop\Projects\Qamar\qamaronline\resources\views/QamarCardCard/Index.blade.php ENDPATH**/ ?>